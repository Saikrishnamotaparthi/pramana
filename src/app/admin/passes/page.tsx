...
export default function PassManagement() {
    ...
    const resetForm = () => {
        setShowForm(false);
        setEditingId(null);
        setFormData({ type: 'single', active: true, status: 'available', groupSize: 1, showRemaining: true, category: 'all' });
    };
        ...
        <div className="flex min-h-screen bg-pramana-black text-pramana-cream font-playfair selection:bg-pramana-gold selection:text-black">
            ...
            <main className="flex-1 p-8 overflow-y-auto max-h-screen bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-gray-900 via-black to-black">
                <header className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-3xl font-cinzel font-bold text-pramana-gold">Pass Management</h1>
                        <p className="text-pramana-cream/60 mt-1">Create and manage event passes.</p>
                    </div>
                    {!isViewOnly && !showForm && (
                        <button
